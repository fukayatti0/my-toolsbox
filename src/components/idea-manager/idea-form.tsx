...
const IdeaForm: React.FC<{
  ...
  const handleChange = (
    ...
    if (index !== undefined) {
      ...
      setIdea((prevIdea) => {
        const updatedArray = [...(prevIdea[name as keyof Idea] as string[])];
        updatedArray[index] = value;
        return { ...prevIdea, [name]: updatedArray };
      });
    } else {
  ...
  const handleAddField = (field: "languages" | "frameworks") => {
    setIdea((prevIdea) => ({
      ...prevIdea,
      [field]: [...prevIdea[field], ""],
    }));
  };
